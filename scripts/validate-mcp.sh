...
ADRKIT_MCP_SHA512="sha512-+7cyLPcBUMiDzSRIfNvBogkNOzRh9SJLaGYbvJFr14PB/qEiFXvSN2Uucuv4Pr/ZJXJhQPUMHnU/MzFWK0Gbag=="

# The adrkit commit this repository pins everywhere else -- the commit behind the
# v0.12.0 release tag. Kept in sync with scripts/validate-queue.sh; step 3 is what
...
# @adrkit/mcp@0.12.0` would re-resolve by name and could execute a cached or
